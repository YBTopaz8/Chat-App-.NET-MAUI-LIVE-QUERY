...
public partial class MainPage : ContentPage
{
    ...
    private void FolderView_LongPressed(object sender, EventArgs e)
    {

    }

    private async void FolderView_TouchDown(object sender, EventArgs e)
    {
    }

    private async void TapGest_Tapped(object sender, TappedEventArgs e)
    {
        var folderitem = e.Parameter as SeedrFolderItem;
        await Vm.LoadSpecificFolder(folderitem.Id.ToString());
        var ew = e.Buttons;
        if (ew == ButtonsMask.Secondary)
        {

        }

    }
    private async void FileTapGest_Tapped(object sender, TappedEventArgs e)
    {
        var folderitem = e.Parameter as SeedrFileItem;
        await Vm.DownloadFileInBrowserAsync(folderitem.Id);
        var ew = e.Buttons;
        if (ew == ButtonsMask.Secondary)
        {
    ...
    private void LinkEditor_Focused(object sender, FocusEventArgs e)
    {

    }

    private void LinkEditor_TextChanged(object sender, TextChangedEventArgs e)
    {

    }

    private void LinkEditor_Unfocused(object sender, FocusEventArgs e)
    {
...
//            Subscription<TestChat>? subscription = await LiveClient!.SubscribeAsync(query);
...
//            TestChat? existingChat = query; // Fetch the first matching object
